...
const EditGigModal = () => {
  ...
  const { ShowEditGigModal, handleCloseEditGigModal, EditGigInfo } =
  ...
  //@NOTE: BUG HERE .. Not Submitting without changing price
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body>
          <p>Editing Gig # - {EditGigInfo.gigID}</p>
              ...
              <Row className="mb-1 p-2 justify-content-center">
                ...
                >
                  ...
                  <CurrencyInput
                    ...
                    defaultValue={EditGigInfo.startingPrice}
